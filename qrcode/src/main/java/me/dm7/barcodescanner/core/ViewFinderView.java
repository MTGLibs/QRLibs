...
import com.masterlibs.qrcode.R;
...
//        canvas.drawRect(0, 0, getWidth(), getHeight() / 4, mFinderMaskPaint);

//        canvas.drawRect(0, getHeight() / 4, getWidth() / 4, getHeight(), mFinderMaskPaint);

        canvas.drawRect(0, 3 * getHeight() / 4, getWidth(), 100, mFinderMaskPaint);

//        canvas.drawRect(0, getBottom() + 1, getWidth(), getHeight(), mFinderMaskPaint);
    }

    public void drawViewFinderBorder(Canvas canvas) {
        Rect framingRect = new Rect(200, 200, 200, 200);
